...
const content = `<template>
  <div>
    ...
    <div class="card">
      ...
      <div v-else-if="filteredParts.length === 0" class="text-center py-8 text-gray-500">
            ...
            >
              ...
              <td class="py-3">
                <div class="flex items-center gap-2">
                  <span class="font-bold" :class="part.stock <= part.min_stock ? 'text-red-400' : 'text-white'">
                    {{ part.stock }}
                  </span>
              ...
              <td class="py-3">
                <span class="text-xs px-2 py-1 rounded-full" :class="statusClass(part.status)">
                  {{ part.status }}
                </span>
              </td>
              <td class="py-3">
