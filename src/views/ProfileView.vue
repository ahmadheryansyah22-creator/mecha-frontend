  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="card flex flex-col items-center text-center py-8">
        ...
        <p class="text-sm mt-1" :style="{ color: 'var(--text-muted)' }">{{ user.phone || '-' }}</p>
      </div>
...
import {
  ...
  LockClosedIcon, KeyIcon, CheckIcon, ArrowPathIcon
...
const roleLabel = computed(() => ({ bengkel: 'Admin Bengkel', mekanik: 'Mekanik' }[user.value.role] || 'Admin'))
